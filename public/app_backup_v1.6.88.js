...
document.addEventListener('DOMContentLoaded', () => {
    console.log("🚀 DOM Loaded. Checking Event Status...");
    var eventDate = new Date("2026-04-24T18:00:00");
    if (new Date() >= eventDate) {
        console.log("✅ Event is LIVE. Bypassing Countdown.");
        var cd = document.getElementById('countdown-display');
        var mc = document.getElementById('main-event-content');
...
console.log("🚀 System v1.6.121 INITIALIZING...");
...
async function init() {
    console.log("[Resilience] Initializing Application v1.6.121 (STABLE)...");
    ...
    var versionBadge = document.getElementById('debug-version-badge');
    if (versionBadge) versionBadge.textContent = "v1.6.121 (STABLE)";
